...
public class KafkaRoutes {
    ...
    public void init() {
        ...
        producerDestination = new StringBuilder().append("kafka:KafkaSample-Topic1").append("?valueSerializer=org.trials.kafka.kafkasample.util.GenericKafkaSerializer").toString();
        consumerDestination = new StringBuilder().append("kafka:KafkaSample-Topic1").append("?valueDeserializer=org.trials.kafka.kafkasample.util.GenericKafkaDeserializer").toString();
    }
